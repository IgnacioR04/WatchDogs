<!-- trader_prompt.md generado 2026-09-22T10:13:52+00:00 -->
...
| GSAT | 11.0% | satellite | 83.04 | 0.24% | 1.28% | 0.83% |
...
| VG | 2.0% | satellite | 13.66 | -2.57% | -10.31% | -3.62% |
| TYRA | 1.8% | satellite | 25.65 | -0.31% | 2.31% | -1.54% |
| GTE | 1.6% | satellite | 9.91 | -3.79% | -6.24% | 0.0% |
| USAR | 1.5% | satellite | 16.78 | 9.17% | 6.81% | -12.88% |
...
| GME | 76 | corporate_insider | Attal Alain | 2 | $401,958 | cluster_buy |
| LEN, LEN.B | 73 | corporate_insider | BERKSHIRE HATHAWAY INC | 0 | $93,075,791 | - |
...
- **sec_insiders**: `ok` · 704 registros 30d · ultimo dato 2026-09-21
...
1. **Universo permitido**: tickers de la cartera candidata (`DT, GLD, GME, GPI, GSAT, GTE, IEF, MEOH, MG, QQQ, SPY, TLT, TYRA, USAR, VG`), de las señales de la seccion 3, o posiciones que ya tengas abiertas (mantener siempre es legal), siempre que tengan datos de precio. No inventes tickers que no aparezcan en este briefing ni en tu cartera.
